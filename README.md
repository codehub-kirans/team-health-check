...
1.  Once you've cloned the project and installed dependencies with `npm install` (or `pnpm install` or `yarn`), download the pocketbase binary for your platform from https://pocketbase.io/docs/. Current supported version of Pocketbase is 0.36. Download the zipped binary from [here](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.9). Extract the contents of the downloaded archive under the backend directory
